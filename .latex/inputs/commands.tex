...
%-------------------------------------
% Example: \invfb{7}
\newcommand{\invfb}[1]{$#1 \, \text{fb}^{-1}$} 

\def\hltrkee{Hlt2RD\_BuToKpEE\_MVA}
\def\hltrkmm{Hlt2RD\_BuToKpMuMu\_MVA}
%-------------------------------------
...
\newcommand{\textgreen}[1]{\color{ForestGreen}#1 \color{black}} % This requires \usepackage[dvipsnames]{xcolor}
...
\newcommand{\rx}[1][black]{\color{#1}$R_X$\color{black}}
\newcommand{\rk}[1][black]{\color{#1}$R_K$\color{black}}
\newcommand{\rkst}[1][black]{\color{#1}$R_{K^*}$\color{black}}

\newcommand{\bvee}{$B\to V e^+e^-$}
